...
function MyInfo({ loading, setLoadNum }: Props) {
  ...
  const TitleBoxTextArr = ['How to use', '오늘도 Book Comment를 찾아주셔서 감사합니다.',
    '원하시는 책을 검색해 후기를 달아보세요. 내가 읽었던 책들도 보여준답니다. 책을 검색해보세요!']
  const InfoBoxClassArr = ['MyInfo IB title', 'MyInfo IB info', 'MyInfo IB title',
    'MyInfo IB info', 'MyInfo IB title', 'MyInfo IB info'];
